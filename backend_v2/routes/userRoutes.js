...
// ========================================
// ONBOARDING ROUTES (accessible during onboarding process)
// ========================================
...
// ========================================
// EMPLOYEE SELF-SERVICE ROUTES (requires completed onboarding)
// ========================================
router.get('/me', authorize('EMPLOYEE', 'HR', 'ADMIN'), getMyProfile);           // Get current user's own profile
