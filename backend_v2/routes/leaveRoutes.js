...
// EMPLOYEE ROUTES
// ========================================
router.get('/summary', authorize('EMPLOYEE', 'HR', 'ADMIN'), getLeaveSummary);    // Get user's leave summary and balance

// ========================================
// HR/ADMIN ROUTES
// ========================================
router.get('/pending', authorize('HR', 'ADMIN'), getPendingLeaves);              // Get list of pending leave requests
router.get('/stats', authorize('HR', 'ADMIN'), getLeaveStats);                   // Get leave statistics
router.get('/pending-approvals', authorize('HR', 'ADMIN'), getPendingApprovals); // Get pending approvals
