...
const { login, getMe, updateDetails, changePassword, forgotPassword, resetPassword,
  logout, mobileLogin, verifyOTP, resendOTP, setOnboardingPassword, getOnboardingData
...
router.get('/onboarding-data/:mobileNumber', getOnboardingData);                    // Get user onboarding data by mobile number
