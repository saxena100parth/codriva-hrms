...
exports.sendOnboardingApprovedNotification = async (user, tempPassword = null) => {
  const subject = 'Onboarding Approved - Welcome to HRMS';
  const text = `
    Congratulations! Your onboarding has been approved.
    
    You can now log in with your official email and temporary password.
    
    ${user.email ? `
    Official Email: ${user.email}
    ${tempPassword ? `Temporary Password: ${tempPassword}` : ''}
    Employee ID: ${user.employeeId || 'TBD'}
