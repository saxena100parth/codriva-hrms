                ...
                <div className="flex items-center">
                    <div className="flex-shrink-0">
                        <img
                            ...
                            src={`https://ui-avatars.com/api/?name=${user?.fullName?.first || user?.displayName || 'User'}&background=3b82f6&color=fff&bold=true&size=64`}
                            alt={user?.fullName?.first || user?.displayName || 'User'}
                        />
                    </div>
                    <div className="ml-3 flex-1 min-w-0">
                        <p className="text-sm font-medium text-gray-900 truncate">{user?.fullName?.first || user?.displayName || 'User'}</p>
                            ...
                            {!isMobile && (
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-2 text-sm font-medium text-gray-700 hidden lg:block">
                                        {user?.fullName?.first || user?.displayName || 'User'}
                                    </span>
                                </div>
                            )}
                        </div>
